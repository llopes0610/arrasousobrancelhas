        ...
        <div className="container-premium relative">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-white/55 sm:text-base sm:leading-8">
              Conheça os principais procedimentos disponíveis no Studio Arrasou
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {services.map((service, index) => {
              ...
              return (
                <article
                  ...
                  "
                >
                  <span className="absolute right-6 top-4 font-serif text-6xl italic text-black/[0.035]">
                    0{index + 1}
                  </span>
                  ...
                  <h2 className="mt-6 font-serif text-3xl font-medium text-arrasou-black">
                    {service.title}
                  </h2>
            ...
            >
              <div>
                ...
                <h2 className="mt-5 font-serif text-4xl font-medium leading-tight">
